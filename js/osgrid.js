+function ($) {
    ...
    var defaultTemplate = "<div class=\"table-responsive text-center\"><table class=\"table table-bordered table-hover\"><thead class=\"page-list-header\"></thead><tbody class=\"page-list-content\"></tbody></table></div><div class=\"well pagination-container\" style=\"padding: 10px; line-height: 1;\"><div class=\"row-fluid page-list-footer\"></div></div>";
    ...
    var OSGrid = function (element, option) {
        ...
        if (!this.opt.Methods.FooterFormat) {
            this.opt.Methods.FooterFormat = function (page) {
                ...
                var pageHtml = "";
                if (page.TotalPage > 0) {
                    pageHtml += "<div class=\"pagination span6\">" +
                ...
                // 3.  显示总数
                var countHtml = "<div class=\"span6\"><span style=\"line-height: 2.5\">第 " + page.CurrentPage + " 页，总 " + page.TotalPage + " 页，总 "+ page.Total +" 条记录 </span></div>";
